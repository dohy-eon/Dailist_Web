    ...
    <div className='space-y-4'>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2'>
        <div className='bg-white p-2 rounded-lg shadow'>
          ...
          <p className='mt-1 text-2xl font-semibold text-gray-900'>{stats.totalHabits}</p>
        </div>
        <div className='bg-white p-2 rounded-lg shadow'>
        ...
        <div className='bg-white p-2 rounded-lg shadow'>
          ...
          <p className='mt-1 text-2xl font-semibold text-gray-900'>{stats.streak}일</p>
        </div>
        <div className='bg-white p-2 rounded-lg shadow'>
      ...
      <div className='bg-white p-2 rounded-lg shadow'>
        <h3 className='text-lg font-medium text-gray-900 mb-2'>습관별 주간 완료율</h3>
        <div className='h-64'>
